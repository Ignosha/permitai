    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fafafa' }}>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #loading-bar { position: fixed; top: 0; left: 0; height: 2px; background: #C0FE04; z-index: 1000; transition: width 0.3s ease; width: 0%; opacity: 1; }
        .header { position: fixed; top: 0; left: 0; right: 0; z-index: 50; padding: 20px 40px; display: flex; justify-content: space-between; align-items: center; mix-blend-mode: difference; }
        ...
        .nav-links a { color: #888; text-decoration: none; font-size: 0.75rem; font-weight: 500; letter-spacing: 0.05em; text-transform: uppercase; transition: color 0.2s; position: relative; }
        .nav-links a::before { content: ''; position: absolute; inset: -4px -8px; border: 2px dotted transparent; transition: border-color 0.2s; pointer-events: none; }
        .nav-links a:hover { color: #fafafa; }
        .nav-links a:hover::before { border-color: #fafafa; }
        .nav-cta { padding: 10px 24px; background: #fafafa; color: #0a0a0a; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; text-decoration: none; transition: all 0.2s; }
        .nav-cta:hover { background: #C0FE04; }
        ...
        .nav-cta-secondary:hover { border-color: #fafafa; background: rgba(255,255,255,0.02); }
        ...
        .btn-primary:hover { background: #a8d904; transform: translateY(-2px); }
        .btn-secondary { background: transparent; color: #fafafa; border: 1px solid #222; }
        .btn-secondary:hover { border-color: #fafafa; background: rgba(255,255,255,0.02); }
        .hero-right { grid-column: 7 / 13; display: flex; flex-direction: column; justify-content: flex-end; padding-bottom: 40px; }
        .hero-meta { font-family: 'JetBrains Mono', monospace; font-size: 0.75rem; color: #555; line-height: 1.8; }
        .hero-meta .value { color: #C0FE04; }
        ...
        .cta-section { padding: 160px 40px; text-align: center; border-top: 1px solid #222; }
        ...
        .footer-column a:hover { color: #C0FE04; }
        ...
        @media (max-width: 640px) {
          ...
          .hero, .features, .testimonials, .cta-section, footer { padding-left: 20px; padding-right: 20px; }
        }
      `}</style>
      ...
      <header className="header">
        ...
        <nav className="nav-links">
          ...
          <a href="#faq">FAQ</a>
          <a href="/pricing" className="nav-cta-secondary">Sign In</a>
      ...
      <main>
        ...
        <section className="hero">
          ...
          <div className="hero-right">
            <div className="hero-meta">
              <div>Version 2.0 — <span className="value">LIVE</span></div>
              <div style={{ marginTop: 8 }}>Permits processed: <span className="value">12,847</span></div>
              <div style={{ marginTop: 8 }}>Avg. approval time: <span className="value">48hrs</span></div>
              <div style={{ marginTop: 8 }}>First-pass rate: <span className="value">92.4%</span></div>
              <div style={{ marginTop: 8 }}>Uptime: <span className="value">99.9%</span></div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="features">
          <div className="section-header">
            ...
            <h2 className="section-title">Everything you need to get permits faster.</h2>
        ...
        <section id="proof" className="testimonials">
          <div className="section-header">
            ...
            <h2 className="section-title">Trusted by contractors & homeowners.</h2>
          </div>
          <div className="testimonials-grid">
            <div className="testimonial">
              <div className="testimonial-text">"I used to spend half a day every week on permit research. PermitAI cut that to 20 minutes. First-time approval rate went from 60% to 95%. This tool pays for itself on the first project."</div>
              <div className="testimonial-author">Mike R.</div>
              <div className="testimonial-role">Licensed General Contractor, Austin TX</div>
            </div>
            <div className="testimonial">
              <div className="testimonial-text">"As a DIYer, permits terrified me. The language, the forms, the fear of getting it wrong. PermitAI walked me through my kitchen remodel step-by-step. Permit approved in 3 days with zero corrections."</div>
              <div className="testimonial-author">Sarah K.</div>
              <div className="testimonial-role">Homeowner, Denver CO</div>
            </div>
            <div className="testimonial">
              <div className="testimonial-text">"We run 15-20 projects a month. PermitAI saves my project managers 10+ hours each week. That's $3,000+ in recovered labor every month. Best tool we've added this year."</div>
      ...
      <script dangerouslySetInnerHTML={{ __html: `
        window.addEventListener('load', () => {
          ...
          if (bar) { bar.style.width = '100%'; setTimeout(() => { bar.style.opacity = '0'; }, 500); }
        });
